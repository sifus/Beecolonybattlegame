    ...
    subLevels: [
      {
        ...
        type: 'movement',
        title: 'Déplacement',
        instructions: 'Fait glisser ton doigt au dessus d\'un arbre pour sélectionner ses abeilles. Puis tape là ou tu veux les emmener (essaye un autre arbre).',
        completed: false,
        stars: 0,
      },
      {
        ...
        type: 'build_hive',
        title: 'Construction',
        instructions: 'Envoyer tes abeilles sur un arbre fané et double-clique dessus pour y créer une ruche.',
        completed: false,
        stars: 0,
      },
      {
        ...
        type: 'double_hive',
        title: 'Amélioration',
        instructions: 'Tu peux créer une 2ème ruche sur un groupe d\'arbres.',
        completed: false,
        stars: 0,
      },
      {
